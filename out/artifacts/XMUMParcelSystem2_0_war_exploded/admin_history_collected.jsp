		...
		<div class = "border settings">
			<div class = "selection">
				<table width = "100%" style="text-align: center;" cellpadding="3px 0px">
					...
					<tr><td>
						<a href="admin_history_collected.jsp"><button class = "button" style="border-left:2px solid black;"> Collected</button></a>
					</td></tr>
				</table>
			</div>
			<div class = "edit">
				<div style="text-align: center;">
					<h1 style="font-size: 2em"> Collected Parcels </h1> <!--Uncollected-->
					<hr>
				</div>
				<table class="table table-striped" width = "100%" cellpadding="6.5px"; style = "margin: 10px auto; padding: 5px" id="parcel">
