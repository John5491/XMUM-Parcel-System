		...
		<div class = "border settings">
			<div class = "selection">
				<table width = "100%" style="text-align: center;" cellpadding="3px 0px">
					<tr><td>
						<a href="history.jsp"><button class = "button" style="border-left:2px solid black;"> All</button></a>
					</td></tr>
					<tr><td>
						<a href="history_uncollected.jsp"> <button class = "button"> Uncollected</button></a> <!--LINKSSS!!!-->
					</td></tr>
					<tr><td>
			...
			<div class = "edit">
				...
				<table class="table" id="pending" width = "100%" cellpadding="6.5px"; style = "margin: 10px auto; padding: 5px">
					<thead  class="thead-inverse">
						<tr style="font-size:1.1em; background-color:#84a8e1;">
							<th width="10%"><b>No.</b></th>
							<th width="25%"><b>Tracking Number</b></th>
							<th width="15%"><b>Courier</b></th>
							<th width="20%"><b>Expected Arrival Date</b></th>
							<th width="20%"><b>Status</b></th>
							<th width="10%"><b>Ops</b></th>
						</tr>
					</thead>
					<tbody>
						<%
				...
				<table class="table" id="collected" width = "100%" cellpadding="6.5px"; style = "margin: 10px auto; padding: 5px">
					<thead  class="thead-inverse">
						<tr style="font-size:1.1em; background-color:#84a8e1;">
							<th width="10%"><b>No.</b></th>
							<th width="25%"><b>Tracking Number</b></th>
					...
					<tbody>
						<%
							sql = "select * from parcel where status = 'Picked-up' and (student_ID = '" + session.getAttribute("username") + "')";
							rs = stm.executeQuery(sql);
							counter = 0;
							while(rs.next()) {
								counter++;
