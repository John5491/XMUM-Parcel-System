				...
				<table class="table" id="uncollected">
					...
					<tbody>
						<%
							...
							String sql = "select * from parcel where trackingNo = '" + request.getParameter("target") + "'";
						...
						<%
							...
							sql = "select * from pendingparcel where trackingNo = '" + request.getParameter("target") + "'";
						...
						%>
									<tr>
										...
										<td>
											<%
												if(rs.getString("studentID").equals(session.getAttribute("username")))
												{
											%>
