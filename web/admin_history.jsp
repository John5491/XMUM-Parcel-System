		...
		<div class = "border settings">
			<div class = "selection">
				<table width = "100%" style="text-align: center;" cellpadding="3px 0px">
					<tr><td>
						<a href="admin_history.jsp"><button class = "button" style="border-left:2px solid black;"> All</button></a>
					</td></tr>
					<tr><td>
						<a href="admin_history_uncollected.jsp"><button class = "button"> Uncollected</button></a> <!--LINKSSS!!!-->
					</td></tr>
					<tr><td>
						<a href="admin_history_ongoing.jsp"><button class = "button"> Ongoing</button></a>
					</td></tr>
					<tr><td>
			...
			<div class = "edit">
				...
				<table class="table table-striped" width = "100%" cellpadding="6.5px"; style = "margin: 10px auto; padding: 5px" id="uncollected">
					<thead class="thead-inverse">
						<tr style="font-size:1.1em; background-color:#84a8e1;">
							...
							<th width="5%"><b>Parcel No.</b></th>
							<th width="15%"><b>Tracking Number</b></th>
							<th width="10%"><b>Student Name</b></th>
							<th width="10%"><b>Student ID</b></th>
							<th width="10%"><b>Courier</b></th>
							<th width="10%"><b>Arrival Date</b></th>
							<th width="10%"><b>Collection Date</b></th>
							<th width="10%"><b>Manager Name</b></th>
							<th width="5%"><b>Status</b></th>
						</tr>
					</thead>
					<tbody>
						<%
							sql = "select parcelNo, trackingNo, studentName, student_ID, courierName, dateReceived, datePickup, managerName, status\n" +
									"from manager, parcel\n" +
				...
				<div style="text-align: center">
					<h1 style="font-size: 2em"> Pending Parcels </h1> <!--Ongoing-->
					<hr>
				</div>
				<table class="table table-striped" id="pending" width = "100%" cellpadding="6.5px"; style = "margin: 10px auto; padding: 5px">
					<thead  class="thead-inverse">
						<tr style="font-size:1.1em; background-color:#84a8e1;">
							<th width="5%"><b>No.</b></th>
							<th width="5%"><b>Parcel No.</b></th>
				...
				<div style="height:28px; clear:both;"></div>
				<div style="text-align: center">
					<h1 style="font-size: 2em"> Collected Parcels </h1> <!--Collected-->
					<hr>
				</div>
				<table class="table table-striped" id="collected" width = "100%" cellpadding="6.5px"; style = "margin: 10px auto; padding: 5px">
					<thead  class="thead-inverse">
						<tr style="font-size:1.1em; background-color:#84a8e1;">
							<th width="5%"><b>No.</b></th>
							<th width="5%"><b>Parcel No.</b></th>
					...
					<tbody>
						<%
							sql = "select parcelNo, trackingNo, studentName, student_ID, courierName, dateReceived, datePickup, managerName, status\n" +
									"from manager, parcel\n" +
									"left join student on parcel.student_ID = student.studentID\n" +
									"where manager.managerID = parcel.manager_ID and status = 'Picked-up'\n" +
									"order by parcelNo asc";;
							rs = stm.executeQuery(sql);
							counter = 0;
							while(rs.next()) {
