	...
	<body>
		<div class = "content-wrap">
			...
			<div class = "border track">
				<div class="adminstudentbg" style="margin-right: 12px">
				...
				<div class = "Your_title">
					<h1> Search Result </h1> <!--Uncollected-->
					<hr>
						...
						<tbody>
							<%
								...
								String sql = "select R.sid as sid, R.sname as sname, R.semail as semail, R.totalr as totalr, P.totalp as totalp\n" +
										...
										"\t) as P\n" +
										"on R.sid = P.sid\n" +
										"where R.sid = '" + request.getParameter("target")+ "' or R.sname = '" + request.getParameter("target") + "'\n" +
