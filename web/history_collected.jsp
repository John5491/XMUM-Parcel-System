		...
		<div class = "border settings">
			<div class = "selection">
				<table width = "100%" style="text-align: center;" cellpadding="3px 0px">
					...
					<tr><td>
						<a href="history_collected.jsp"><button class = "button" style="border-left:2px solid black;"> Collected</button></a>
					</td></tr>
				</table>
			</div>
			<div class = "edit">
				...
				<table class="table" width = "100%" cellpadding="6.5px"; style = "margin: 10px auto; padding: 5px" id="uncollected">
					...
					<tbody>
						<%
							sql = "select * from parcel where (status = 'Picked-up' or status = 'Pickup-up') and (student_ID = '" + session.getAttribute("username") + "')";
